...
CREATE TABLE `regional` (
  ...
  CONSTRAINT `regional_ibfk_1` FOREIGN KEY (`reg_usuario`) REFERENCES `usuarios` (`usua_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `usuarios` (
  ...
  `usua_usuario` varchar(30) DEFAULT NULL,
  `usua_contraseña` varchar(20) DEFAULT NULL,
...
insert  into `usuarios`(`usua_id`,`usua_nombre`,`usua_apellido`,`usua_usuario`,`usua_contraseña`,`usua_rol`,`permiso1`,`permiso2`,`permiso3`,`permiso4`,`permiso5`,`permiso6`,`permiso7`,`permiso8`,`permiso9`,`permiso10`,`permiso11`,`permiso12`,`permiso13`,`permiso14`,`usua_correo`) values (2,'Andres A','Amaya','Andres','1234','administrador',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'andresamayap123123@gmail.com');
